      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a 
              href="https://wa.me/5511999999999?text=Quer dar vida ao seu projeto? Vamos conversar!"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-dhaart-beige text-dhaart-brown-dark px-8 py-4 rounded-full font-raleway font-semibold text-lg hover:bg-white hover:scale-105 transition-all duration-300 shadow-2xl"
            >
